...
export const ModalFooter: React.FC<Props> = ({ children, className, justify = 'normal', sticky = true }) => {
  const theme = useTheme();

  return (
    <Footer theme={theme} sticky={sticky} justifyContent={justify} className={className}>{children}</Footer>
  );
};
